...
export const metadata = {
  ...
  description: 'A comprehensive list of AI-powered capabilities to enhance fitness coaching, client outcomes, and business efficiency.',
};
...
const fitnessCoachAiFunctions = [
    ...
    { name: 'Automated Content Creation', description: "Generates engaging content related to fitness, nutrition, and wellness (e.g., blog posts, social media captions) for marketing and client education", benefit: "Saves time for coaches and expands their online presence" },
